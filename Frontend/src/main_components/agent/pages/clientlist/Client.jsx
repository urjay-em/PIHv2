...
const Client = () => {
  ...
  return (
    <ThemeProvider theme={lightTheme}>
      <Box m="70px" maxWidth="1350px" mx="auto">
        <Box mb={1}>
          <h1 style={{ color: "black", fontSize: "32px", fontWeight: "bold", marginBottom: "6px" }}>
            CLIENTS
          </h1>
          <p style={{ color: "black", fontSize: "18px", fontWeight: "bold", marginTop: "0px" }}>
            List of Clients in the Database
          </p>
        </Box>
