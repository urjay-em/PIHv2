    ...
    <Box m="20px" maxWidth="800px" mx="auto">
      ...
      <Formik
        ...
        initialValues={{
          ...
          account_types: initialValues.account_types || "agent", // Default to "agent"
          commission_rate: initialValues.commission_rate || "",  // Commission rate field
          agent_pic: initialValues.agent_pic || null,  // Profile picture for agent
        }}
        ...
        {({
          ...
          <form onSubmit={handleSubmit}>
            <Grid container spacing={3}>
              ...
              {/* Account Type and Commission Rate Fields */}
              <Grid item xs={12} sm={6}>
                <FormControl variant="filled" fullWidth>
...
const agentSchema = yup.object().shape({
  ...
  account_types: yup.string().required("Account type is required"),
  commission_rate: yup.number().min(0).required("Commission rate is required"),
  agent_pic: yup.mixed().required("Agent picture is required"),
});
